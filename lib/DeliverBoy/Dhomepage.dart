...
//First page of bottom navigation bar present in mainsceen first page when the delivery boy signin or signup
...
class _HomePageState extends State<DHomePage> {
